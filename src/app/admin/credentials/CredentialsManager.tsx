...
type Settings = { bank: Record<string,string>; stripe: Record<string,string|boolean>; s3: Record<string,string|boolean>; smtp: Record<string,string|boolean> };
const fields = {
